...
export default function LoginScreen({ navigation }) {
  const { signIn } = useContext(AuthContext);  // Lấy signIn từ context
  ...
  try {
    ...
    // Không cần navigation.navigate → App sẽ tự render AppStack
  } catch (error) {
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 30, fontWeight: 'bold', color: '#004aad' },
  subtitle: { fontSize: 24, fontWeight: 'bold', marginTop: 5 },
  text: { fontSize: 14, color: 'gray', marginTop: 5 },
